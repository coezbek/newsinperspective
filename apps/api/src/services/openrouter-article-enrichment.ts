...
export async function extractArticleEnrichmentWithOpenRouter(
  ...
  const prompt = [
    ...
    "- IMPORTANT: when the article is newsworthy and mentions named people / organizations / places, populate the corresponding arrays. Empty arrays should be the EXCEPTION (genuinely no named entity of that type appears in the article), not the default. A typical news story has 2–6 people, 2–6 organizations, and 3–8 places.",
    "- spell each name as it appears in the article; include titles only when integral (e.g. \"Dr. Maria Van Kerkhove\" → \"Maria Van Kerkhove\", but \"King Charles III\" stays as \"King Charles III\")",
    "- include news agencies, ministries, and government bodies in organizations (e.g. \"World Health Organization\", \"Argentina Health Ministry\", \"Reuters\")",
    "- include countries, regions, cities, and named landmarks in places",
    ...
    "Examples:",
    "Example 1 input title: WHO confirms human-to-human hantavirus transmission on cruise",
    "Example 1 input body excerpt: \"Maria Van Kerkhove, the World Health Organization's director of epidemic and pandemic preparedness, said Tuesday that a Dutch couple who died after spending time on the MV Hondius likely contracted the Andes strain in Argentina. Argentina's health ministry and Spain's Ministry of Health are coordinating the evacuation of about 140 passengers from the cruise ship in Tenerife, with support from the U.S. Centers for Disease Control and Prevention. Oceanwide Expeditions, the Dutch operator, said it is cooperating with WHO investigators based in Geneva.\"",
    "Example 1 output: {\"isNewsworthy\":true,\"notNewsworthyReason\":null,\"keywords\":[\"hantavirus outbreak\",\"MV Hondius\",\"WHO\",\"Andes virus\",\"Canary Islands evacuation\"],\"translatedTitle\":\"WHO confirms human-to-human hantavirus transmission on cruise\",\"translatedSummary\":\"The World Health Organization confirmed limited human-to-human hantavirus transmission aboard the MV Hondius cruise ship, with Argentina, Spain, and the Netherlands coordinating an evacuation of passengers in Tenerife.\",\"translatedFullText\":\"<cleaned body>\",\"framingSummary\":\"The piece foregrounds the WHO's epidemiological framing — a 'limited' outbreak driven by close-contact transmission — and treats the Argentine landfill near Ushuaia as the likely environmental source rather than the ship itself. Maria Van Kerkhove's quotes dominate the lede; Argentine officials are positioned as cooperative rather than defensive. The story emphasizes coordinated multinational response and downplays the panic angle that other outlets foreground.\",\"persons\":[\"Maria Van Kerkhove\"],\"organizations\":[\"World Health Organization\",\"Argentina Health Ministry\",\"Spain Ministry of Health\",\"U.S. Centers for Disease Control and Prevention\",\"Oceanwide Expeditions\"],\"places\":[\"Argentina\",\"Spain\",\"Tenerife\",\"Netherlands\",\"Geneva\",\"Ushuaia\"],\"language\":\"en\",\"bodyAppearsTruncated\":false}",
    ...
    "Example 3 (sports): Body opens 'Real Madrid have fined midfielders Federico Valverde and Aurelien Tchouameni 500,000 euros each for refusing to take penalties in the Champions League semifinal loss to PSG at the Bernabeu, the club said Friday.'",
    "Example 3 output: {\"isNewsworthy\":true,\"notNewsworthyReason\":null,\"keywords\":[\"Real Madrid\",\"Champions League\",\"PSG\",\"player discipline\",\"Bernabeu\"],\"translatedTitle\":\"Real Madrid fines Valverde, Tchouameni 500,000 euros each\",\"translatedSummary\":\"Real Madrid fined midfielders Federico Valverde and Aurelien Tchouameni 500,000 euros each for refusing to take penalties in the Champions League semifinal loss to PSG.\",\"translatedFullText\":\"<cleaned body>\",\"framingSummary\":\"The article treats the fines as an institutional rebuke rather than a financial detail, framing Valverde and Tchouameni as the visible faces of a wider locker-room rift after the Bernabeu defeat. PSG's role is reduced to context; the lede centres on internal accountability at Real Madrid.\",\"persons\":[\"Federico Valverde\",\"Aurelien Tchouameni\"],\"organizations\":[\"Real Madrid\",\"PSG\"],\"places\":[\"Bernabeu\"],\"language\":\"en\",\"bodyAppearsTruncated\":false}",
    "",
